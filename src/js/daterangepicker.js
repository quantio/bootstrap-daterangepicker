...
!function ($, moment) {
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (calendar, selected, minDate, maxDate, side) {
      ...
      function header() {
        switch (self.viewMode.toLowerCase()) {
          case "months":
            return calendar[1][1].year();
          default:
            return self.locale.monthNames[calendar[1][1].month()] + calendar[1][1].format(" YYYY");

        }
      }

      function daysOfWeekLabels() {
        var html = '';
        switch (self.viewMode.toLowerCase()) {
          case "months":
            html = '';
      ...
      function calendarBody() {
        ...
        function classNames(date) {
          ...
          if ((minDate && date.isBefore(minDate)) || (maxDate && date.isAfter(maxDate))) {
            ...
            if (date.isSame(self.startDate)) {
              classes.push('start-date');
            }
            if (date.isSame(self.endDate)) {
              classes.push('end-date');
            }
          }
          return classes.join(' ');
        ...
        function renderMonths() {
          ...
          for (var row = 0; row < 3; row++) {
            ...
            for (var col = 0; col < 4; col++) {
              ...
              html += '<td class="' + classNames(calendar[row][col]) + '" data-title="' + title + '">' + self.locale.monthNames[calendar[row][col].month()] + '</td>'
            }
            html += '</tr>';
          }
          return html;
        ...
        function renderDays() {
          ...
          for (var row = 0; row < 6; row++) {
            ...
            for (var col = 0; col < 7; col++) {
              var title = 'r' + row + 'c' + col;
              html += '<td class="' + classNames(calendar[row][col]) + '" data-title="' + title + '">' + calendar[row][col].date() + '</td>';
            }
            html += '</tr>';
          }
          return html;
