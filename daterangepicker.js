    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.rightCalendar = {
                ...
                month: moment([this.endDate.year(), this.endDate.month(), this.endDate.daysInMonth(), this.endDate.hour(), this.endDate.minute(), this.endDate.second()]),
                calendar: []
            };
        ...
        updateFormDateInput: function(name, date, isActive) {
          var e = this.container.find(name);
          e.val(date.format(this.format));
          if(isActive)
            e.addClass('active');
          else
        ...
        updateFormInputs: function () {
            this.updateFormDateInput('input[name=daterangepicker_start]', this.startDate, false);
            this.updateFormDateInput('input[name=daterangepicker_end]', this.endDate, false);
        ...
        hoverDate: function (e) {
            ...
            if (cal.hasClass('left')) {
              this.updateFormDateInput('input[name=daterangepicker_start]', this.leftCalendar.calendar[row][col], true);
            } else {
              this.updateFormDateInput('input[name=daterangepicker_end]', this.rightCalendar.calendar[row][col], true);
            }
        },
        ...
        buildCalendar: function (month, year, hour, minute, seconds, side) {
          if (this.minViewMode == 'month') {
            ...
            return buildCalendarOriginal(month, year, hour, minute, side);
          }

        },

        buildCalendarOriginal: function (month, year, hour, minute, second, side) {
        ...
        renderDropdownsOriginal: function (selected, minDate, maxDate) {
            var currentMonth = selected.month();
            var currentYear = selected.year();
            var maxYear = (maxDate && maxDate.year()) || (currentYear + 5);
            var minYear = (minDate && minDate.year()) || (currentYear - 50);
        ...
        renderCalendarOriginal: function (calendar, selected, minDate, maxDate, side) {
